...
import Icon from "vuepress-theme-hope/lib/client/components/Icon";

import type { PropType, VNode } from "vue";
import type { AutoLink } from "vuepress-theme-hope/lib/shared";
            ...
            return renderRouterLink.value
                ? h(
                    RouterLink,
                    {
                        ...
                        onClick: () => Bus.emit("close"),   // 对点击事项进行响应，用来完成锚点跳转之后的导航栏缩起
                    },
                    () =>
                        slots["default"]?.() || [
